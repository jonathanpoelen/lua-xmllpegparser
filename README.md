...
```bash
luarocks install --local https://raw.githubusercontent.com/jonathanpoelen/lua-xmllpegparser/master/xmllpegparser-2.2-1.rockspec

# or in your local directory lua-xmllpegparser

luarocks make --local xmllpegparser-2.2-1.rockspec
```
